...
export class CheckoutPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, private formBuilder: FormBuilder,
    ...
    this.formBilling = this.formBuilder.group({
      ...
      postcode: [this.billingData.postcode, Validators.required],
    ...
    this.formShipping = this.formBuilder.group({
      first_name: [this.shippingData.first_name, Validators.required],
      ...
      postcode: [this.shippingData.postcode, Validators.required],
