...
export class ProductPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, private WC: WooCommerceProvider,
    ...
    public settings: SettingsProvider, private modalCtrl: ModalController, private platform: Platform, private admob: AdMobFree) {
  ...
  loadProducts() {
    ...
    this.products = [];
    this.WC.getCustomProducts(this.page, this.per_page, this.sortby, this.items[1].id, this.params.search, this.items[0].min_price, this.items[0].max_price, this.on_sale, this.featured, this.filterData).subscribe((res: any) => {
