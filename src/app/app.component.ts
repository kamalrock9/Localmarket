...
import { RestProvider, SettingsProvider, WooCommerceProvider, ToastProvider, UserProvider } from './../providers/providers';
...
export class MyApp {
  ...
  constructor(public platform: Platform, private statusBar: StatusBar, private zone: NgZone, public settings: SettingsProvider,
    public translate: TranslateService, private events: Events, rest: RestProvider, private toast: ToastProvider,
    private modalCtrl: ModalController, private emailComposer: EmailComposer, private appRate: AppRate,
    private alertCtrl: AlertController, private appVersion: AppVersion, private WC: WooCommerceProvider,
    public user: UserProvider, ionicApp: IonicApp, menuCtrl: MenuController, private iab: InAppBrowser,
    private anlyticsService: AnalyticsService, private loader: LoadingProvider, private imageLoaderConfig: ImageLoaderConfig) {
