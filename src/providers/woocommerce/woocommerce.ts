...
export class WooCommerceProvider {
  ...
  //   });
  // }
  getProductById(include) {//Multiple ids suppoerted(include=1,2,3,4,5)
    return this.http.get(this.RestURL + "get-products-by-id?include=" + include);
  }
  ...
  getCustomProducts(page, per_page, sort, category, search, min_price?, max_price?, on_sale?, featured?, filterData?) {
    ...
    return this.http.post(this.RestURL + "custom-products" + p + pp + s + c + sh + min_p + max_p + os + f, filterData);
  }
  getProductThumb(id) {
